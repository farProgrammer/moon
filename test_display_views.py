...
class DisplayViewTestCase(TestCase):
    ...
    def test_show_homepage(self):
        with app.test_client() as client:
            ...
            self.assertIn("moon", html)  # test html
            # checking that logged in homepage is not displaying for this route
    ...
    def test_show_loggedin_homepage(self):
        with app.test_client() as client:
            ...
            html = resp.get_data(as_text=True)  # pull html resp
            # checking that html supports redirects
    ...
    def test_show_mission_info(self):
        with app.test_client() as client:
            ...
            html = resp.get_data(as_text=True)  # pull html resp
            # checking that html supports display
            self.assertIn("Curiosity", html)
